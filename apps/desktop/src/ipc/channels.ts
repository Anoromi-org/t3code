...
export const LIST_HYPRNAV_AGENTS_CHANNEL = "desktop:list-hyprnav-agents";
export const REQUEST_HYPRNAV_SCREENCAST_CHANNEL = "desktop:request-hyprnav-screencast";
export const GOTO_HYPRNAV_AGENT_CHANNEL = "desktop:goto-hyprnav-agent";
