...
`com.anoromi.t3code` record. The production workflow validates its numeric form, explicitly rejects
upstream's known App Store ID, and injects it before starting an iOS build.
