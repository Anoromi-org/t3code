...
import Migration0041 from "./Migrations/041_ProjectionThreadsForkOrigin.ts";
import Migration0042 from "./Migrations/042_ProjectionProjectsHyprnavSettings.ts";
import Migration0043 from "./Migrations/043_NormalizeProjectHyprnavScopes.ts";
import Migration0044 from "./Migrations/044_RestoreInheritedProjectHyprnavNulls.ts";
import Migration0045 from "./Migrations/045_RepairProviderInstanceIdProjectionColumns.ts";
import Migration0046 from "./Migrations/046_RepairProjectionThreadLatestTurnIds.ts";
import Migration0047 from "./Migrations/047_ProviderSessionRuntimeIndexes.ts";
import Migration0048, {
  prepareForkMigrationPrerequisites,
} from "./Migrations/048_RepairForkMigrationCompatibility.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadsForkOrigin", Migration0041],
  [42, "ProjectionProjectsHyprnavSettings", Migration0042],
  [43, "NormalizeProjectHyprnavScopes", Migration0043],
  [44, "RestoreInheritedProjectHyprnavNulls", Migration0044],
  [45, "RepairProviderInstanceIdProjectionColumns", Migration0045],
  [46, "RepairProjectionThreadLatestTurnIds", Migration0046],
  [47, "ProviderSessionRuntimeIndexes", Migration0047],
  [48, "RepairForkMigrationCompatibility", Migration0048],
] as const;
